<template>
  <div class="post-form mb-2">
    <div class="px-10 pt-4 pb-16 bg-gray-100 rounded-lg">
      ...
      <vs-row>
        <vs-col vs-w="6">
          <vs-select placeholder="VD: Hà Nội" class="" label="Tỉnh trả hàng" v-model="post.fromCityId">
      ...
      <vs-row>
        <vs-col vs-w="6">
          <vs-input class="mb-2" label="Giá từ (VND)" color="danger" v-model="post.lowestPrice" placeholder="VD: 100000"></vs-input>
        </vs-col>
        <vs-col vs-w="6">
          <vs-input class="mb-2" label="Giá tối đa (VND)" v-model="post.highestPrice" color="danger" placeholder="VD: 500000"></vs-input>
        </vs-col>
      </vs-row>
      <vs-textarea class="w-full" label="Chi tiết bài đăng" color="danger" v-model="post.content" placeholder="Nói thêm về cách thức giao hàng, nhận hàng,..."></vs-textarea>
      <div class="">
