<template>
  <div id="home-main" class="scroll-smooth" v-scroll="onScroll">
    <div class="relative" :class="{ 'header-book': $route.fullPath == '/home' }">
      <About />
      <Header />
      <Promo />
...
#home-main {
  .header-book {
    background-image: url('../../assets/img/user/bg-image-main.jpeg');
